        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/portfolio/GRS.png" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/GRS1.png" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3> ENGINEERING,IT,PERIODICAL AND GENERAL REFERENCE SECTION</h3>

            </div>
            <div class="portfolio-description">
              <p>
                In the same location, are our Engineering, IT
                book collections, General Refences and
                Scholary Journals. Reading area is provided.
              </p>
            </div>
          </div>
