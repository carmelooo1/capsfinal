        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/portfolio/FIL.png" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/FIL1.png" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3> FILIPINIANA SECTION</h3>

            </div>
            <div class="portfolio-description">
              <p>
                Go up to the second floor is the Filipiniana
                section. This housed the Books authored by
                Filipino authors and the contents are all
                about the Philippines or authored by foreign
                authors but its all about the Philipinnes.
              </p>
            </div>
          </div>
